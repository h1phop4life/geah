...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/geah)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/geah
```

A live public deployment of this template is available at [https://geah.templates.workers.dev](https://geah.templates.workers.dev)
